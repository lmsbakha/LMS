                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <c:if test="${sessionLevel == 1}">   
	                        <li>
	                            ...
	                            <ul class="submenu-angle app-mini-nb-dp" aria-expanded="false">
	                                <li> <a title="과제" href="${pageContext.request.contextPath}/loginCheck/reportList"><span class="mini-sub-pro">과제</span></a> </li>
	                                <li><a title="시험" href="${pageContext.request.contextPath}/loginCheck/examForStudent"><span class="mini-sub-pro">시험</span></a></li>
	                                <li><a title="성적" href="departments.html"><span class="mini-sub-pro">성적</span></a></li>
	                                <li><a title="교재" href="departments.html"><span class="mini-sub-pro">교재</span></a></li>
                        ...
                        <c:if test="${sessionLevel == 2}">
                         <li>
                            ...
                            <ul class="submenu-angle app-mini-nb-dp" aria-expanded="false">
                                ...
                                <li><a title="과제관리" href="${pageContext.request.contextPath}/loginCheck/reportList"><span class="mini-sub-pro">과제관리</span></a></li>
                        ...
                        <c:if test="${sessionLevel >= 3}">
                         <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                            	<li><a title="출결관리" href="${pageContext.request.contextPath}/loginCheck/attendanceForManager"><span class="mini-sub-pro">출결관리</span></a></li>
                                ...
                                <li><a title="직원관리" href="${pageContext.request.contextPath}/loginCheck/memberList?memberCheck=teacher"><span class="mini-sub-pro">직원관리</span></a></li>
                                 <!-- 총관리자 로그인 시 -->
                       ...
                       <li>
                            ...
                            <ul class="submenu-angle app-mini-nb-dp" aria-expanded="false">
                                <li><a title="강좌관리" href="departments.html"><span class="mini-sub-pro">강좌관리</span></a></li>
                                <li><a title="과목관리" href="departments.html"><span class="mini-sub-pro">과목관리</span></a></li>
                                <li><a title="과제관리" href="${pageContext.request.contextPath}/loginCheck/reportList"><span class="mini-sub-pro">과제관리</span></a></li>
                                <li><a title="시험관리" href="${pageContext.request.contextPath}/loginCheck/exam"><span class="mini-sub-pro">시험관리</span></a></li>
                                <li><a title="문제은행" href="${pageContext.request.contextPath}/loginCheck/questionBank"><span class="mini-sub-pro">문제은행</span></a></li>
                                <li><a title="성적관리" href="${pageContext.request.contextPath}/loginCheck/grade"><span class="mini-sub-pro">성적관리</span></a></li>
