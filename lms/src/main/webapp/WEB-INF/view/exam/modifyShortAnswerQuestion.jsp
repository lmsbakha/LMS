							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<ul class="breadcome-menu" style="float: left;">
										...
										<li><a href="#">
												<span class="bread-blod" style="font-weight: bold;">단답형 문제 수정</span>
											</a></li>
									</ul>
								</div>
							</div>
								...
								<table>
									...
									<tr>
										...
										<th>
											...
											<a href="${pageContext.request.contextPath}/loginCheck/removeShortAnswerQuestion?questionNo=${shortAnswerQuestion.questionNo}" onclick="return confirm('문제를 삭제하시겠습니까?');">
