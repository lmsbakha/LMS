															...
															<div class="devit-card-custom">
																...
																<div class="form-group-inner">
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<input type="text" class="form-control" id="questionTitle" name="questionTitle" required="required" placeholder="문제 지문" />
																		</div>
																	</div>
																</div>
																<!-- 보기 -->
																<div class="form-group-inner">
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<div class="input-group">
																				<span class="input-group-addon">1번</span> <input type="text" class="form-control" id="answer1" name="answer1" required="required"> <span class="input-group-addon"> <input type="checkbox" id="questionAnswer" name="questionAnswer" value="1">
																				</span>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<div class="input-group">
																				<span class="input-group-addon">2번</span> <input type="text" class="form-control" id="answer2" name="answer2" required="required"> <span class="input-group-addon"> <input type="checkbox" id="questionAnswer" name="questionAnswer" value="2">
																				</span>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<div class="input-group">
																				<span class="input-group-addon">3번</span> <input type="text" class="form-control" id="answer3" name="answer3" required="required"> <span class="input-group-addon"> <input type="checkbox" id="questionAnswer" name="questionAnswer" value="3">
																				</span>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<div class="input-group">
																				<span class="input-group-addon">4번</span> <input type="text" class="form-control" id="answer4" name="answer4" required="required"> <span class="input-group-addon"> <input type="checkbox" id="questionAnswer" name="questionAnswer" value="4">
																				</span>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			<div class="input-group">
																				<span class="input-group-addon">5번</span> <input type="text" class="form-control" id="answer5" name="answer5" required="required"> <span class="input-group-addon"> <input type="checkbox" id="questionAnswer" name="questionAnswer" value="5">
																				</span>
																			</div>
																		</div>
																	</div>
