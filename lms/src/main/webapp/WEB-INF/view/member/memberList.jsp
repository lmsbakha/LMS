							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<ul class="breadcome-menu" style="float: left;">
										...
										<li><a href="#">회원관리</a> <span class="bread-slash">/</span></li>
										...
										<c:if test="${memberCheck eq 'teacher'}">
											<li><span class="bread-blod" style="font-weight: bold;">강사관리</span></li>
										</c:if>
										<c:if test="${memberCheck eq 'manager'}">
											<li><span class="bread-blod" style="font-weight: bold;">직원관리</span></li>
										</c:if>
									</ul>
								</div>
							</div>
